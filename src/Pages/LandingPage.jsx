    ...
    <>
          ...
          <div className="left text-gray-500">
            <div className="landing-desc flex">
              ...
              <p>
                ...
                range of job opportunities in TECH industries.
              </p>
            </div>
          </div>
          <div className="right">
      ...
      <div className="ourservice">
        <div className="our-service-main">
          <span className="text-[3rem] text-gray-600 font-semibold pb-5 lg:mb-12">Our Service </span>
          <div className="service-desc w-full py-2">
            <div className="service-desc-2 service-common">
              ...
              <div className="desc">
                ...
                chatting with them. You can get recommendation from them in their companies.
              </div>
            </div>
            <div className="service-desc-3 service-common">
              ...
              <div className="desc">
                To eliminate crowding, we have separated our job listing into various
            ...
            <div className="service-desc-4 service-common">
              ...
              <div className="desc">
                Here you can get directly recommendations from the alumni and your seniors who are currently working in big tech companies.
              </div>
            </div>
            <div className="service-desc-5 service-common">
              ...
              <div className="desc">
                You can connect with alumni and get career guidance and feedback about your skill improvement.
              </div>
            </div>
            <div className="service-desc-6 service-common">
              ...
              <div className="desc">
                To maintain the privacy of individual users, we use password-secured authentication.
              </div>
            </div>
            <div className="service-desc-7 service-common">
              ...
              <div className="desc">
                Alumni will give their feedback and also share their work experience with you individually. They will provide you with the best career guidance.
              </div>
            </div>
      ...
      {/* ================================  Why SheRise  ================================= */}
      <div className="whysherise-main lg:flex pb-5 mb-5 text-gray-500">
        <div className="px-10 lg:w-1/2 lg:p-[8rem]">
          <img
            src="https://ik.imagekit.io/sayancr777/tr:w-400/SheRise/whysherise.svg?updatedAt=1689503441644"
            alt=""
          />
        </div>
        <div className="px-10 lg:w-1/2 lg:py-[10rem] space-y-2">
            ...
            <ul className="flex space-y-1 flex-col mr-10 ">
              ...
              <li className="">
                <span className=" ">
                  ...
                  feature to help users log in to their profiles.
                </span>
              </li>
            </ul>
          </div>
      ...
      <footer className="text-center text-gray-600 border-t border-gray-300 py-1">
        <span className="text-center">2024 © Copyright Reserved </span>
      </footer>
    </>
  );
};
